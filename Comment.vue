<template>
  <div class="hbl-fa">
    ...
    <sub-comment @doChildSendDown="doChildSendDown(arguments)" :childrenList="commentList" :label="label" :avatar="avatar" :placeholder="placeholder" :minRows="minRows" :maxRows="maxRows" :author-id="authorId"></sub-comment>
